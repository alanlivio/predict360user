...
class ProjectionTest(unittest.TestCase):
    ...
    def test_sphere_rect(self):
        ...
        # self.some_traces.metrics_vpextract_video(VPEXTRACTS_RECT, plot_bars=False, plot_traces=False, plot_heatmaps=False)
    ...
    def test_shpere_voro(self):
        ...
        # self.some_traces.metrics_vpextract_video(VPEXTRACTS_VORO, plot_bars=False, plot_traces=False, plot_heatmaps=False)
